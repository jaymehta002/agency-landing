      ...
      >
        <div className='grid grid-cols-2 gap-4'>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.5, delay: 0.4 }}
          >
            <Image height={1080} width={1080} src='/images/culture2.png' alt='Image 1' className='w-full' />
          ...
          <motion.div 
            ...
            transition={{ duration: 0.5, delay: 0.6 }}
          >
            <Image height={1080} width={1080} src='/images/culture3.png' alt='Image 2' className='w-full' />
          ...
          <motion.div 
            ...
            transition={{ duration: 0.5, delay: 0.8 }}
          >
            <Image height={1080} width={1080} src='/images/culture4.png' alt='Image 3' className='w-full' />
          ...
          >
            <Image height={1080} width={1080} src='/images/culture5.png' alt='Image 4' className='w-full' />
          </motion.div>
          </div>    
        </div>
      </motion.div>
