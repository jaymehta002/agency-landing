    ...
    <>
      ...
      <footer>
        <div className="container mx-auto p-8">
          ...
          <div className="grid md:grid-cols-6 grid-cols-5 place-items-center gap-4 mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center text-center justify-between mb-4">
