...
const HeroPage = () => {
  return (
    <>
      <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.5, delay:0.2}}  className="hero-wave"></motion.div>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <motion.h1
              ...
              className="text-6xl max-w-1/2 font-grifter font-bold text-gray-800 mb-4"
            >
              Fluttering Your <br /> Ideas Into Digital Reality
            </motion.h1>
            <div className="">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="2xl:hidden xl:hidden md:block justify-center flex flex-col gap-4"
          >
            <div className="flex gap-4">
              <img
                src={data.hero.images[0]}
