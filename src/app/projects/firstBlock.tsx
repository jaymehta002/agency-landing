...
const FirstBlock: React.FC<FirstBlockProps> = ({
  ...
  return (
    <div id="#" className={`p-4 lg:p-8 rounded-xl flex flex-col lg:flex-row items-center justify-between lg:mx-12 md:mx-8 mx-6  px-4 lg:px-8`} style={{backgroundColor: background}}>
